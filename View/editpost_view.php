    ...
    <body>
        ...
        <input type="hidden" name="code" id='id' value="<?php  echo $_REQUEST["id"]?>">
            <tr>
                ...
                <div align="center"><input name="title" type="text" id="title" value="<?php echo  $edit['title'] ?>" /></div></td>
            </tr>
            <tr>
                <th scope="row"><div align="center">Content</div></th>
                <div align="center"><input name="content" type="text" id="content" value="<?php echo  $edit['content'] ?>"/></div></td>
            </tr>
            <tr>
                <input type="file" name="fileToUpload" id="fileToUpload" >

                <input type="submit" value="Update" name="update" id="update" >
                </br> <span ><?php echo  $edit['images'] ?></span>
            </tr>
        </form>
